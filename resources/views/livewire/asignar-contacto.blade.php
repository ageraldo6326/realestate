                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                <div class="assign-stat">
                                    ...
                                    <div class="h3 mb-0 font-weight-bold">{{ $clientes->total() }}</div>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="assign-stat">
                                    <div class="small text-uppercase" style="opacity:.76; letter-spacing:.08em;">En página</div>
                                    <div class="h3 mb-0 font-weight-bold">{{ $clientes->count() }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                @forelse ($clientes as $cliente)
                                    ...
                                    <tr>
                                        <td class="pl-4">
                                            ...
                                            <div class="contact-meta">ID #{{ $cliente->id }}</div>
                                            <div class="contact-meta d-lg-none">{{ $cliente->telefono ?: 'Sin teléfono' }}</div>
                                        </td>
                                        <td>
                                            <span class="assign-badge {{ $statusClass }}">{{ $cliente->estatus ?: 'SIN ESTATUS' }}</span>
                                        </td>
                                        <td>
                                            <span class="assign-badge {{ $probabilityClass }}">{{ $cliente->probabilidades ?: 'DESCONOCIDA' }}</span>
                                        </td>
                                        <td class="d-none d-lg-table-cell">
                                            <span class="contact-meta">{{ $cliente->telefono ?: 'Sin teléfono' }}</span>
                                        </td>
                                        <td class="d-none d-xl-table-cell">
                                            <div class="assign-owner">
                                                <span class="assign-owner-label">Captador</span>
                                                <span class="assign-owner-name">{{ $cliente->captador_name ?: 'Sin asignar' }}</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="assign-owner">
                                                <span class="assign-owner-label">Asesor</span>
                                                <span class="assign-owner-name">{{ $cliente->asignado_name ?: 'Sin asignar' }}</span>
                                            </div>
                                        </td>
                                        <td class="text-center pr-4">
                                            <div class="assign-actions">
                                                <button type="button" class="btn btn-light border assign-action-btn text-danger"
                                                    ...
                                                    data-element-id="{{ $cliente->id }}" title="Eliminar contacto">
                                                    <i class="fa fa-trash"></i>
                                                </button>
                                                <button type="button" class="btn btn-success assign-primary-action"
                                                    wire:click="asignarContacto({{ $cliente->id }})" data-toggle="modal"
        ...
        <div class="row">
            ...
            <div class="card card-body shadow">
                ...
                <div class="col-md-12"> 
                        ...
                        <div class="col-md-12">
                            <div class="my-3">
                                <label for="" class="form-label">Notas @if($id_nota!="") ID:{{$id_nota}} @endif</label>
                        ...
                        <div class="row justify-content-end">
                            <div class="col-md-2">
                                ...
                                @if($id_nota=="") Grabar @else Actualizar @endif
                                </button>
                            </div>
                            <div class="col-md-2">
                                <button type="button" 
                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                @error('nota') <span class="error text-danger p-2">{{ $message }} ....</span> @enderror
                            </div>
            ...
            <div class="row" >
                <div class="col-md-12 mb-3 table-responsive">
                        ...
                        <div class="row">
                            <div class="row justify-content-end">
                                <div class="col-md-6">
                                    <a class="btn btn-success btn-block m-1 p-1"  @if($id_tarea=="") wire:click='agregartarea' @else wire:click='actualizartarea({{$id_tarea}})' @endif role="button">@if($id_tarea=="") Grabar @else Actualizar @endif</a>
                                </div>
                                <div class="col-md-6">
        ...
        <div class="modal-content">
            ...
            <div class="assign-modal-body">
                <div class="assign-contact-card">
                    ...
                    <div class="h5 mb-1">@if($contacto_actual) {{ $contacto_actual->nombre }} @else Selecciona un contacto @endif</div>
                    <div class="text-muted">@if($contacto_actual) Tel. {{ $contacto_actual->telefono ?: 'Sin teléfono' }} @endif</div>
                    @if($contacto_actual)
                        <div class="assign-contact-current">
                            <i class="fa fa-user"></i>
                            <span>Asignado actualmente a: {{ optional($contacto_actual->user2)->name ?? 'Sin asignar' }}</span>
                        </div>
                    @endif
                </div>
            ...
            <div class="modal-footer bg-white border-0 px-4 pb-4 pt-0">
                ...
                <button type="button" class="btn btn-success px-4" wire:click.prevent="asignar()" @if(!$asignado_a) disabled @endif>Guardar asignación</button>
            </div>
        </div>
        </div>
    </div>
