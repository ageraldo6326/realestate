                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="ltn__social-media">
                                            <ul>
                                                <li><a href="@if (isset($inmo->facebook)) {{ $inmo->facebook }} @endif" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="@if (isset($inmo->instagram)) {{ $inmo->instagram }} @endif" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                                                <li><a href="@if (isset($inmo->whatsapp)) {{ $inmo->whatsapp }} @endif" title="Whatsapp"><i class="fab fa-whatsapp"></i></a></li>
                                                <li><a href="@if (isset($inmo->tiktok)) {{ $inmo->tiktok }} @endif" title="Tiktok"><i class="fab fa-tiktok"></i></a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li>
