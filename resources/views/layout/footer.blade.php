                ...
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-6 ltn__secondary-bg text-center---">
                        <div class="coll-to-info text-color-white">
                            <h1>Buscando la casa de tu sueños?</h1>
                            <p>Te ayudamos a que tu sueño de tener un nuevo hogar</p>
                        </div>
                        <div class="btn-wrapper">
                            <a class="btn btn-effect-3 btn-white" href="contact.html">Explorar Propiedades <i class="icon-next"></i></a>
                        </div>
                    </div>
                </div>
            </div>
