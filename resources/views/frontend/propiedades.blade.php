...
@section('seo_title', 'Propiedades en Venta y Alquiler — ' . ($inmo->titulo ?? 'Portal Inmobiliario'))
@section('seo_description', 'Explora nuestra lista completa de propiedades en venta y alquiler. Filtra por zona, tipo y
    precio.')
...
@section('content')
    ...
    <section class="listings-section">
        <div class="container">
            @livewire('buscar-propiedades-propiedades')
        </div>
    </section>
