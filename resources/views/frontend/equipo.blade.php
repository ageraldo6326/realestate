                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <article class="agent-card h-100">
                            ...
                            <div class="agent-body">
                                <h3 class="agent-name">{{ $usuario->name }}</h3>
                                @if ($usuario->titulo)
                                    <p class="agent-role">{{ $usuario->titulo }}</p>
                                @endif
                                @if ($usuario->telefono)
                                    <p class="agent-phone"><i class="fas fa-phone"></i>{{ $usuario->telefono }}</p>
                                @endif
                                <a href="{{ route('propiedadesPorAgente', $usuario->id) }}" class="btn-ver-props">
