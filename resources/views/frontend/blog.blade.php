...
@section('seo_title', 'Novedades — ' . ($inmo->titulo ?? 'Portal Inmobiliario'))
@section('seo_description', 'Lee las últimas noticias y artículos sobre el mercado inmobiliario.')
                    ...
                    <div class="col-lg-4 col-md-6">
                        <article class="blog-card">
                            <div class="blog-body">
                                ...
                                <h2 class="blog-title">
                                    <a href="{{ route('post.show', $post->slug) }}">{{ $post->titulo }}</a>
                                </h2>
                                <p class="blog-excerpt">{!! Str::limit(strip_tags($post->contenido), 160) !!}</p>
                            </div>
                            <div class="blog-footer">
                                <p class="blog-author mb-0">Por: <span>{{ $post->autor }}</span></p>
                                <a href="{{ route('post.show', $post->slug) }}" class="btn-read-more">
