...
@section('content')
    ...
    <div class="container-fluid empresa-editor py-4">
        <section class="editor-hero mb-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                <div>
                    <h1 class="editor-title mb-1">Editar empresa</h1>
                    <p class="editor-subtitle mb-0">Actualiza la configuracion institucional y los activos visuales usando la
                        interfaz actual del backend.</p>
                </div>
                <a href="{{ route('inmobiliaria.index') }}" class="btn btn-outline-secondary">Refrescar formulario</a>
            </div>
        </section>
    </div>
    ...
    <form action="{{ route('inmobiliaria.update', $inmobiliaria->id) }}" method="post" enctype="multipart/form-data"
        novalidate>
        @method('put')
        @csrf
        @include('admin.empresa.partials.form-fields', ['inmobiliaria' => $inmobiliaria])
    </form>
