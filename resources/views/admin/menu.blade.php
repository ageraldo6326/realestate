            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @if ($isAdmin)
                    ...
                    <li class="nav-item {{ $activeSistema ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"><a href="{{ route('usuarios.index') }}"
                                    class="nav-link {{ request()->routeIs('usuarios.*') ? 'active' : '' }}"><i
                            ...
                            <li class="nav-item"><a href="{{ route('tipopropiedades.index') }}"
                                    class="nav-link {{ request()->routeIs('tipopropiedades.*') ? 'active' : '' }}"><i
                                        class="nav-icon fas fa-city fa-fw"></i>
                                    <p>Tipos de propiedad</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('estados.index') }}"
                                    class="nav-link {{ request()->routeIs('estados.*') ? 'active' : '' }}"><i
                                        class="nav-icon fas fa-toggle-on fa-fw"></i>
                                    <p>Estados</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('disponiblepara.index') }}"
                                    class="nav-link {{ request()->routeIs('disponiblepara.*') ? 'active' : '' }}"><i
                                        class="nav-icon fas fa-tag fa-fw"></i>
                                    <p>Disponible para</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('tipostareas.index') }}"
                                    class="nav-link {{ request()->routeIs('tipostareas.*') ? 'active' : '' }}"><i
                    ...
                    <li class="nav-item {{ $activeWebsite ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"><a href="{{ route('portadas.index') }}"
                                    class="nav-link {{ request()->routeIs('portadas.*') ? 'active' : '' }}"><i
                                        class="nav-icon fas fa-image fa-fw"></i>
                                    <p>Portadas</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('testimonios.index') }}"
                                    class="nav-link {{ request()->routeIs('testimonios.*') ? 'active' : '' }}"><i
                                        class="nav-icon fas fa-quote-right fa-fw"></i>
                                    <p>Testimonios</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('posts.index') }}"
                                    class="nav-link {{ request()->routeIs('posts.*') ? 'active' : '' }}"><i
                                        class="nav-icon fas fa-blog fa-fw"></i>
                                    <p>Blog / Posts</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('enfoques.index') }}"
                                    class="nav-link {{ request()->routeIs('enfoques.*') ? 'active' : '' }}"><i
                ...
                <li class="nav-item {{ $activeCrm ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ $activeCrm ? 'active' : '' }}">
                        <i class="nav-icon fas fa-briefcase"></i>
                        <p>CRM <i class="right fas fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item"><a href="{{ route('clientes.index') }}"
                                class="nav-link {{ request()->routeIs('clientes.*') ? 'active' : '' }}"><i
                                    class="nav-icon fas fa-user-plus fa-fw"></i>
                                <p>Contactos</p>
                            </a></li>
                        @if ($isAdmin)
                            <li class="nav-item"><a href="{{ route('asignar') }}"
                                    class="nav-link {{ request()->routeIs('asignar') ? 'active' : '' }}"><i
                                        class="nav-icon fas fa-user-check fa-fw"></i>
                                    <p>Asignar contacto</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('import.index') }}"
                                    class="nav-link {{ request()->routeIs('import.index') ? 'active' : '' }}"><i
                                        class="nav-icon fas fa-file-import fa-fw"></i>
                                    <p>Importar contactos</p>
                                </a></li>
                        @endif
                        <li class="nav-item"><a href="{{ route('verificar') }}"
                                class="nav-link {{ request()->routeIs('verificar') ? 'active' : '' }}"><i
                                    class="nav-icon fas fa-search fa-fw"></i>
                                <p>Consultar contacto</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('propiedades.index') }}"
                                class="nav-link {{ request()->routeIs('propiedades.*') ? 'active' : '' }}"><i
                                    class="nav-icon fas fa-home fa-fw"></i>
                                <p>Mis propiedades</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('mostrarinventario') }}"
                                class="nav-link {{ request()->routeIs('mostrarinventario') ? 'active' : '' }}"><i
                                    class="nav-icon fas fa-list fa-fw"></i>
                                <p>Inventario</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('todo.index') }}"
                                class="nav-link {{ request()->routeIs('todo.*') ? 'active' : '' }}"><i
                                    class="nav-icon fas fa-check-square fa-fw"></i>
                                <p>Tareas</p>
                            </a></li>
                        <li class="nav-item"><a href="{{ route('calendario') }}"
                                class="nav-link {{ request()->routeIs('calendario') ? 'active' : '' }}"><i
                                    class="nav-icon fas fa-calendar-alt fa-fw"></i>
                                <p>Agenda</p>
                            </a></li>
                        @if ($isAdmin)
                            <li class="nav-item"><a href="{{ route('registrarventa') }}"
                                    class="nav-link {{ request()->routeIs('registrarventa') ? 'active' : '' }}"><i
                ...
                <li class="nav-item"><a href="{{ route('dashboardasesor') }}"
                        class="nav-link {{ request()->routeIs('dashboardasesor') ? 'active' : '' }}"><i
                ...
                <li class="nav-item {{ $activeReportes ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        @if ($isAdmin)
                            <li class="nav-item"><a href="{{ route('clientespotenciales') }}"
                                    class="nav-link {{ request()->routeIs('clientespotenciales') ? 'active' : '' }}"><i
                                        class="fas fa-user-plus nav-icon"></i>
                                    <p>Clientes potenciales</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('clientescerrados') }}"
                                    class="nav-link {{ request()->routeIs('clientescerrados') ? 'active' : '' }}"><i
                                        class="fas fa-handshake nav-icon"></i>
                                    <p>Clientes cerrados</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('fuenteclientes') }}"
                                    class="nav-link {{ request()->routeIs('fuenteclientes') ? 'active' : '' }}"><i
                                        class="fas fa-bullhorn nav-icon"></i>
                                    <p>Fuente de clientes</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('tareasporcategorias') }}"
                                    class="nav-link {{ request()->routeIs('tareasporcategorias') ? 'active' : '' }}"><i
                                        class="fas fa-tasks nav-icon"></i>
                                    <p>Tareas por categoria</p>
                                </a></li>
                            <li class="nav-item"><a href="{{ route('propiedadesclick') }}"
                                    class="nav-link {{ request()->routeIs('propiedadesclick') ? 'active' : '' }}"><i
                                        class="fas fa-mouse-pointer nav-icon"></i>
                                    <p>Propiedades por click</p>
                                </a></li>
                        @endif
                        <li class="nav-item"><a href="{{ route('dashboardventas') }}"
                                class="nav-link {{ request()->routeIs('dashboardventas') ? 'active' : '' }}"><i
                ...
                @if ($isAdmin)
                    ...
                    <li class="nav-item"><a href="{{ route('consultaClientesAsesor') }}"
                            class="nav-link {{ request()->routeIs('consultaClientesAsesor') ? 'active' : '' }}"><i
                                class="nav-icon fas fa-calendar-check fa-fw"></i>
                            <p>Clientes por fecha</p>
                        </a></li>
                    <li class="nav-item"><a href="{{ route('contactostodos') }}"
                            class="nav-link {{ request()->routeIs('contactostodos') ? 'active' : '' }}"><i
                                class="nav-icon fas fa-address-book fa-fw"></i>
                            <p>Todos los contactos</p>
                        </a></li>
                    <li class="nav-item"><a href="{{ route('consultarpropiedades') }}"
                            class="nav-link {{ request()->routeIs('consultarpropiedades') ? 'active' : '' }}"><i
                                class="nav-icon fas fa-th-list fa-fw"></i>
                            <p>Todas las propiedades</p>
                        </a></li>
                    @if ((bool) optional($inmo)->aprobacion)
                        <li class="nav-item"><a href="{{ route('poraprobar') }}"
                                class="nav-link {{ request()->routeIs('poraprobar') ? 'active' : '' }}"><i
