                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-4">
                        <div class="estados-stat">
                            ...
                            <div class="h3 mb-0 font-weight-bold">{{ $estados->total() }}</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="card estados-panel">
                <div class="card-body p-4">
                    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center mb-4">
                        ...
                        <a href="{{ route('estados.create') }}" class="btn btn-primary mt-3 mt-lg-0 px-4">
                            Nuevo estado
                        </a>
                    </div>

                    <form action="{{ route('estados.index') }}" method="GET" autocomplete="off">
                        <div class="row mb-4">
                            <div class="col-lg-8">
                                <label for="filtro-estado" class="small text-muted font-weight-semibold">Buscar estado</label>
                                <input type="text" id="filtro-estado" name="q" value="{{ $filtro }}"
                            ...
                            <div class="col-lg-4 d-flex align-items-end mt-3 mt-lg-0">
                                ...
                                <a href="{{ route('estados.index') }}" class="btn btn-outline-secondary">Limpiar</a>
                            </div>
                        </div>
                    </form>
                        ...
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                @forelse ($estados as $estado)
                                    <tr>
                                        <td class="font-weight-bold">{{ $estado->id }}</td>
                                        <td>
                                            <div class="font-weight-semibold">{{ $estado->estado }}</div>
                                        </td>
                                        <td class="text-right">
