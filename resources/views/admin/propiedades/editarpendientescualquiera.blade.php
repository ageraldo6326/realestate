...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route("updatecualquiera",$propiedad->id) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="titulo" name="titulo" value="{{ $propiedad->titulo }}"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" placeholder="Descripción" id="descripcion" name="descripcion"
                        style="height: 100px">{{ $propiedad->descripcion }}</textarea>
                </div>

                <div class="form-group">
                    <label for="descripcion">Dirección</label>
                    <textarea class="form-control" placeholder="Dirección" id="direccion" name="direccion"
                        style="height: 100px">{{ $propiedad->direccion }}</textarea>
                </div>

                <div class="form-group">
                    <label for="metadescription">Meta Description</label>
                    <textarea class="form-control" placeholder="Meta Description" id="metadescription"
                        name="metadescription" maxlength="160"
                        style="height: 100px">{{ $propiedad->metadescription }}</textarea>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="metraje" name="metraje" placeholder="Metraje"
                                value="{{ $propiedad->metraje }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" @if ($propiedad->destacada==1) checked
                            @endif id="destacada" name="destacada">
                    ...
                    <div class="col-md-2">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" @if ($propiedad->vendida==1) checked @endif
                    ...
                    <div class="col-md-2">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" @if ($propiedad->activa==1) checked @endif
                            id="activa"
                            name="activa">
                    ...
                    <div class="col-md-2">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" @if ($propiedad->aprobada==1) checked @endif
                            id="aprobada"
                            name="aprobada">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->lobby==1) checked
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->plantaelectrica==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->camaravigilancia==1) checked @endif id="camaravigilancia"
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->escaleraemergencia==1) checked @endif id="escaleraemergencia"
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->maderapreciosa==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->balcon==1) checked
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->walkincloset==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->jacuzzi==1) checked
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->areainfantil==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->banovisitas==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->cisterna==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->inversorareacomun==1) checked @endif id="inversorareacomun"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->gascomun==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->gazebo==1) checked
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->pozo==1) checked
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->piscina==1) checked
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->familyroom==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->cuartodeservicio==1) checked @endif id="cuartodeservicio"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->patio==1) checked
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->portonelectrico==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->seguridad24horas==1) checked @endif id="seguridad24horas"
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->ascensor==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->parqueostechados==1) checked @endif id="parqueostechados"
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->preinstalacionairetinacoinversor==1) checked @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->terraza==1) checked
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->estudio==1) checked
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->gimnasio==1)
                            ...
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" @if ($propiedad->controldeacceso==1)
