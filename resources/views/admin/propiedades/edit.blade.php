    ...
    <div class="container-fluid modern-property-create py-4">
        <section class="create-hero mb-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                <div>
                    <h1 class="create-title mb-1">{{ $reviewMode ? 'Revisar y editar propiedad' : 'Editar Propiedad' }}</h1>
                    <p class="create-subtitle mb-0">{{ $reviewMode ? 'Revisa la información completa antes de aprobar o retirar la aprobación.' : 'Actualiza la informacion comercial, SEO y multimedia usando el mismo flujo visual de creacion.' }}</p>
                </div>
            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="d-grid gap-2 gap-sm-3" style="grid-auto-flow: column; grid-auto-columns: 1fr;">
                        ...
                        <a href="{{ $returnUrl }}" class="btn btn-light border">Cancelar</a>
                    </div>
                </div>
            </div>
        </form>
