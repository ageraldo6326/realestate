            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('updatependientes', $propiedad->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        @if ((bool) optional($inmobiliaria)->aprobacion && Auth::user()->rol == 0)
                            <div class="row">
                                        ...
                                        <select class="form-control" name="tipo" id="tipo" required>
                                            ...
                                            @foreach ($tipos_propiedades as $tipos_propiedad)
                                                <option @if ($propiedad->tipo == $tipos_propiedad->id) selected @endif
                                                    value="{{ $tipos_propiedad->id }}">{{ $tipos_propiedad->tipo }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="habitaciones" id="habitaciones" required>
                                            ...
                                            <option @if ($propiedad->habitaciones == 1) selected @endif value="1">1
                                            </option>
                                            <option @if ($propiedad->habitaciones == 2) selected @endif value="2">2
                                            </option>
                                            <option @if ($propiedad->habitaciones == 3) selected @endif value="3">3
                                            </option>
                                            <option @if ($propiedad->habitaciones == 4) selected @endif value="4">4
                                            </option>
                                            <option @if ($propiedad->habitaciones == 5) selected @endif value="5">5
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="banos" id="banos" required>
                                            ...
                                            <option @if ($propiedad->banos == 1) selected @endif value="1">1
                                            </option>
                                            <option @if ($propiedad->banos == 1.5) selected @endif value="1.5">1.5
                                            </option>
                                            <option @if ($propiedad->banos == 2) selected @endif value="2">2
                                            </option>
                                            <option @if ($propiedad->banos == 2.5) selected @endif value="2.5">2.5
                                            </option>
                                            <option @if ($propiedad->banos == 3) selected @endif value="3">3
                                            </option>
                                            <option @if ($propiedad->banos == 3.5) selected @endif value="3.5">3.5
                                            </option>
                                            <option @if ($propiedad->banos == 4) selected @endif value="4">4
                                            </option>
                                            <option @if ($propiedad->banos == 4.5) selected @endif value="4.5">4.5
                                            </option>
                                            <option @if ($propiedad->banos == 5) selected @endif value="5">5
                                            </option>
                                            <option @if ($propiedad->banos == 5.5) selected @endif value="5.5">5.5
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="parqueos" id="parqueos" required>
                                            ...
                                            <option @if ($propiedad->parqueos == 1) selected @endif value="1">1
                                            </option>
                                            <option @if ($propiedad->parqueos == 2) selected @endif value="2">2
                                            </option>
                                            <option @if ($propiedad->parqueos == 3) selected @endif value="3">3
                                            </option>
                                            <option @if ($propiedad->parqueos == 4) selected @endif value="4">4
                                            </option>
                                            <option @if ($propiedad->parqueos == 5) selected @endif value="5">5
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            @if ($propiedad->destacada == 1) checked @endif id="destacada"
                                            name="destacada">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            @if ($propiedad->vendida == 1) checked @endif id="vendida"
                                            name="vendida">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            @if ($propiedad->activa == 1) checked @endif id="activa"
                                            name="activa">
                                ...
                                @if ((bool) optional($inmobiliaria)->aprobacion && $isAdmin)
                                    <div class="col-md-2">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                @if ($propiedad->aprobada == 1) checked @endif id="aprobada"
                                                name="aprobada">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    @if ($propiedad->camaravigilancia == 1) checked @endif
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    @if ($propiedad->escaleraemergencia == 1) checked @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    @if ($propiedad->inversorareacomun == 1) checked @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    @if ($propiedad->cuartodeservicio == 1) checked @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    @if ($propiedad->seguridad24horas == 1) checked @endif
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    @if ($propiedad->parqueostechados == 1) checked @endif
