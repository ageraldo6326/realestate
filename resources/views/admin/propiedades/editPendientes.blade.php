...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <form action="{{ route("updatependientes",$propiedad->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')            
            <input type="hidden" name="id" value="{{ $propiedad->id }}">
            <div class="mb-3">
                <label for="formFile" class="form-label">Foto Principal</label>
                <input class="form-control" type="file" id="foto_portada" name="foto_portada" value="{{ $propiedad->foto_portada }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" value="{{ $propiedad->titulo }}"  placeholder="Titulo" required maxlength="60">
            </div>

            <div class="form-group">
                <label for="descripcion_corta">Descripción corta</label>
                <input type="text" class="form-control" id="descripcion_corta" value="{{ $propiedad->descripcion_corta }}" name="descripcion_corta" placeholder="Descripción corta" required maxlength="160">
            </div>            
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Meta Description" id="metadescription" name="metadescription" maxlength="160" style="height: 100px">{{ $propiedad->metadescription }}</textarea>
            </div>
                ...
                <div class="card-body">            
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="file" id="foto1" name="foto1" value="{{ $propiedad->foto1 }}">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="file" id="foto2" name="foto2"  value="{{ $propiedad->foto2 }}">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="file" id="foto3" name="foto3" value="{{ $propiedad->foto3 }}">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="file" id="foto4" name="foto4" value="{{ $propiedad->foto4 }}">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="file" id="foto5" name="foto5" value="{{ $propiedad->foto5 }}">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="file" id="foto6" name="foto6" value="{{ $propiedad->foto6 }}">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="file" id="foto7" name="foto7" value="{{ $propiedad->foto7 }}">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="file" id="foto8" name="foto8" value="{{ $propiedad->foto8 }}">
                ...
                <div class="card-body"> 
                    <div class="row">           
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="text" id="video1" name="video1" value="{{ $propiedad->video1 }}">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="zona_id" id="zona_id" required>
                            ...
                            @foreach ($zonas as $zona)
                                <option @if ($propiedad->zona_id==$zona->id) selected @endif value="{{ $zona->id }}">{{ $zona->zona }}</option>                                
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="provincia" id="provincia" required>
                            ...
                            @foreach ($provincias as $provincia)
                                <option @if ($propiedad->provincia==$provincia->id) selected @endif value="{{ $provincia->id }}"> {{ $provincia->provincia }}</option>    
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="precio" name="precio" required placeholder="Precio" value="{{ $propiedad->precio }}">
                    </div>
                </div> 
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="comision" name="comision" placeholder="Comision" value="{{ $propiedad->comision }}">
                    </div>
                </div>                 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="tipo" id="tipo" required>
                            ...
                            @foreach ($tipos_propiedades as $tipos_propiedad)
                                <option @if ($propiedad->tipo==$tipos_propiedad->id) selected @endif value="{{ $tipos_propiedad->id}}">{{ $tipos_propiedad->tipo }}</option>    
                            @endforeach
                        </select>
                    </div>
                </div>                
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="disponible_para" id="disponible_para" required>
                            ...
                            @forelse ($disponibles_para as $disponible_para )
                                <option @if ($propiedad->disponible_para==$disponible_para->id) selected @endif value="{{ $disponible_para->id }}">{{ $disponible_para->disponible_para }}</option>
                            @empty
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="estadopropiedad" id="estadopropiedad" required>
                            ...
                            <option @if ($propiedad->estado_id==$estado_propiedad->id) selected @endif  value="{{ $estado_propiedad->id }}">{{
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="metraje" name="metraje" placeholder="Metraje" value="{{ $propiedad->metraje }}" required>
                    </div>
                </div>  
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="metraje_construccion" name="metraje_construccion" placeholder="Metraje de Construcción" value="{{ $propiedad->metraje_construccion }}">
                    </div>
                </div>                

                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" @if ($propiedad->destacada==1) checked @endif id="destacada" name="destacada">
                ...
                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" @if ($propiedad->vendida==1) checked @endif id="vendida" name="vendida">
                ...
                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" @if ($propiedad->activa==1) checked @endif id="activa"
                        name="activa">
                ...
                @if (optional($inmobiliaria)->aprobacion=="on" && Auth::user()->rol==0)
                    <div class="col-md-2">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" @if ($propiedad->aprobada==1) checked @endif id="aprobada"
                            name="aprobada">
...
{{-- Detalles de la propiedad             --}}
    ...
    <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" @if ($propiedad->lobby==1) checked @endif id="lobby" name="lobby">
                ...
                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" @if ($propiedad->plantaelectrica==1) checked @endif id="plantaelectrica" name="plantaelectrica">
                ...
                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" @if ($propiedad->camaravigilancia==1) checked @endif id="camaravigilancia" name="camaravigilancia">
                ...
                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" @if ($propiedad->escaleraemergencia==1) checked @endif id="escaleraemergencia" name="escaleraemergencia">
                ...
                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" @if ($propiedad->maderapreciosa==1) checked @endif id="maderapreciosa" name="maderapreciosa">
                ...
                <div class="col-md-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" @if ($propiedad->balcon==1) checked @endif id="balcon" name="balcon">
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->walkincloset==1) checked @endif id="walkincloset" name="walkincloset">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->jacuzzi==1) checked @endif id="jacuzzi" name="jacuzzi">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->areainfantil==1) checked @endif id="areainfantil" name="areainfantil">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->banovisitas==1) checked @endif id="banovisitas" name="banovisitas">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->cisterna==1) checked @endif id="cisterna" name="cisterna">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->inversorareacomun==1) checked @endif id="inversorareacomun" name="inversorareacomun">
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->gascomun==1) checked @endif id="gascomun" name="gascomun">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->gazebo==1) checked @endif id="gazebo" name="gazebo">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->pozo==1) checked @endif id="pozo" name="pozo">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->piscina==1) checked @endif id="piscina" name="piscina">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->familyroom==1) checked @endif id="familyroom" name="familyroom">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->cuartodeservicio==1) checked @endif id="cuartodeservicio" name="cuartodeservicio">
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->patio==1) checked @endif id="patio" name="patio">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->portonelectrico==1) checked @endif id="portonelectrico" name="portonelectrico">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->seguridad24horas==1) checked @endif id="seguridad24horas" name="seguridad24horas">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->ascensor==1) checked @endif id="ascensor" name="ascensor">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->parqueostechados==1) checked @endif id="parqueostechados" name="parqueostechados">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->preinstalacionairetinacoinversor==1) checked @endif id="preinstalacionairetinacoinversor" name="preinstalacionairetinacoinversor">
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->terraza==1) checked @endif id="terraza" name="terraza">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->estudio==1) checked @endif id="estudio" name="estudio">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->gimnasio==1) checked @endif id="gimnasio" name="gimnasio">
    ...
    <div class="col-md-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" @if ($propiedad->controldeacceso==1) checked @endif id="controldeacceso" name="controldeacceso">
