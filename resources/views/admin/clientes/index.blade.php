            ...
            <div class="col-6 col-lg-3 mb-3 mb-lg-0">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="mb-0 text-success">{{ $stats['activos'] ?? 0 }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="mb-0 text-info">{{ $stats['nuevos'] ?? 0 }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="mb-0 text-primary">{{ $stats['cierres'] ?? 0 }}</h3>
                    </div>
                </div>
            </div>
        </div>

        @livewire('buscar-cliente')
    </div>
