                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="titulo" id="titulo" required>
                            ...
                            <option @if ($cliente->titulo=="Señorita") selected @endif value="Señorita">Señorita</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="tipo_contacto" id="tipo_contacto" required>
                            ...
                            <option @if ($cliente->tipo_contacto=="PersonaFisica") selected @endif value="PersonaFisica">Persona Fisica</option>
                            <option @if ($cliente->tipo_contacto=="Empresa") selected @endif value="Empresa">Empresa</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="comentario" id="comentario" rows="3">{{ $cliente->comentario }}</textarea>
                    </div>

                    <div class="form-group col-4">
                        <label for="contact_at">Fecha de Contacto</label>
                        <input type="date" class="form-control" required id="contact_at" name="contact_at" value="{{ substr($cliente->contact_at,0,10) }}">
                    </div>                    

                    <div class="form-group">
                        <input clase="form-control" type="checkbox" @if ($cliente->activo==1) checked @endif name="activo" id="activo">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="tipo_contacto2" id="tipo_contacto2" required>
                            <option value="">Tipo</option>
                            <option @if ($cliente->tipo_contacto2=="Vendedor") selected @endif value="Vendedor">Vendedor</option>
                            <option @if ($cliente->tipo_contacto2=="Comprador") selected @endif value="Comprador">Comprador</option>
                            <option @if ($cliente->tipo_contacto2=="Inquilino") selected @endif value="Inquilino">Inquilino</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="medio" id="medio" required>
                            ...
                            <option @if ($cliente->medio=="Instagram") selected @endif value="Instagram">Instagram</option>
                            ...
                            <option @if ($cliente->medio=="PaginaWeb") selected @endif value="PaginaWeb">Pagina Web</option>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="zona_id" id="zona_id">
                                            ...
                                            <option @if ($cliente->zona_id==$zona->id) selected @endif value="{{$zona->id}}">{{ $zona->zona }}</option>
                                            @endforeach
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="precio_mini" name="precio_mini" placeholder="Precio" value="{{ $cliente->precio_mini }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="precio" name="precio_max" placeholder="Precio" value="{{ $cliente->precio_max }}">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tipo" id="tipo">
                                            ...
                                            <option @if ($cliente->tipo==$tipos_propiedad->id) selected @endif value="{{ $tipos_propiedad->id}}">{{ $tipos_propiedad->tipo }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="estadopropiedad" id="estadopropiedad">
                                            ...
                                            <option @if ($cliente->estado==$estado_propiedad->id) selected @endif value="{{ $estado_propiedad->id }}">{{$estado_propiedad->estado }}</option>
                                ...
                                <a href="{{ route("veropciones",$cliente->id) }}" target="_blank" class="btn btn-primary btn-lg text-bold text-white">Ver opciones</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="testimonio" id="testimonio" rows="3"></textarea>
                    </div>
