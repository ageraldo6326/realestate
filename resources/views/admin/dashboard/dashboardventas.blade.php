                ...
                <form id="dashboard" method="GET" action="{{ route('dashboardventas') }}" class="report-toolbar">
                    <div class="report-toolbar__item">
                        ...
                        <select class="form-control" name="periodo" id="periodo">
                            <option @if ((string) $periodo === (string) date('Y') || $periodo == '') selected @endif value="{{ date('Y') }}">
                                {{ date('Y') }}</option>
                            <option @if ($periodo == 'Mes pasado') selected @endif value="Mes pasado">Mes pasado</option>
                            <option @if ($periodo == 'Ultimo trimestre') selected @endif value="Ultimo trimestre">Ultimo
                                trimestre</option>
                            <option @if ($periodo == 'Ultimo semestre') selected @endif value="Ultimo semestre">Ultimo
                                semestre</option>
                                ...
                                <div class="col-md-4 col-12 mb-3">
                                    <div class="report-kpi text-center h-100 d-flex flex-column justify-content-center">
                                        ...
                                        <p class="report-kpi__value mb-0">
                                            {{ number_format($ventas_por_asesor->TotalVentas) }}</p>
                                    </div>
                                </div>
                            @empty
                                <div class="col-12">
                            ...
                            @forelse ($ventas_por_asesores_monto as $ventas_por_asesor_monto)
                                <div class="col-md-4 col-12 mb-3">
                                    <div class="report-kpi text-center h-100 d-flex flex-column justify-content-center">
                                        ...
                                        <p class="report-kpi__value mb-0">
                                            {{ number_format($ventas_por_asesor_monto->TotalVentas) }}</p>
                                    </div>
                                </div>
                            @empty
                                <div class="col-12">
