...
@section('page_title', 'Mi Dashboard')
...
<div class="container-fluid px-3">
        ...
        <div class="col-12">
            <div class="card border-0" style="background:rgba(37,99,235,.04);">
                <div class="card-body py-2 px-3 d-flex flex-wrap align-items-center" style="gap:.75rem;">
                    ...
                    <form id="dashboard" method="GET" action="{{ route('dashboardasesor') }}" class="d-flex align-items-center" style="gap:.5rem;">
                        <select class="form-control form-control-sm" name="periodo" id="periodo" style="min-width:160px;">
                            <option @if($periodo == date('Y')) selected @endif value="{{ date('Y') }}">{{ date('Y') }}</option>
                            <option @if($periodo == 'Mes pasado') selected @endif value="Mes pasado">Mes pasado</option>
                            <option @if($periodo == 'Ultimo trimestre') selected @endif value="Ultimo trimestre">Último trimestre</option>
                            <option @if($periodo == 'Ultimo semestre') selected @endif value="Ultimo semestre">Último semestre</option>
                            <option @if($periodo == 'Ano pasado') selected @endif value="Ano pasado">Año pasado</option>
                        </select>
                    </form>
                    @if($fi && $ff)
                        <span class="badge badge-light border text-muted" style="font-size:.78rem;padding:.3rem .6rem;">
                            <i class="fas fa-clock mr-1"></i>{{ $fi }} → {{ $ff }}
                        </span>
                    @endif
                </div>
            </div>
        ...
        <div class="col-6 col-md-4 col-xl-2 mb-3">
            <div class="card border-0 h-100">
                <div class="card-body d-flex align-items-center p-3">
                    ...
                    <div>
                        <div class="h4 mb-0 font-weight-700">{{ $ventas->CantidadVentas ?? 0 }}</div>
        ...
        <div class="col-6 col-md-4 col-xl-2 mb-3">
            <div class="card border-0 h-100">
                <div class="card-body d-flex align-items-center p-3">
                    ...
                    <div>
                        <div class="h4 mb-0 font-weight-700" style="font-size:1rem;">{{ number_format($ventas->TotalMontoVentas ?? 0) }}</div>
        ...
        <div class="col-6 col-md-4 col-xl-2 mb-3">
            <div class="card border-0 h-100">
                <div class="card-body d-flex align-items-center p-3">
                    ...
                    <div>
                        <div class="h4 mb-0 font-weight-700" style="font-size:1rem;">{{ number_format($ventas->TotalComisiones ?? 0) }}</div>
        ...
        <div class="col-6 col-md-4 col-xl-2 mb-3">
            <div class="card border-0 h-100">
                <div class="card-body d-flex align-items-center p-3">
                    ...
                    <div>
                        <div class="h4 mb-0 font-weight-700" style="font-size:1rem;">{{ number_format($ventas->VentaPromedio ?? 0) }}</div>
        ...
        <div class="col-6 col-md-4 col-xl-2 mb-3">
            <div class="card border-0 h-100">
                <div class="card-body d-flex align-items-center p-3">
                    ...
                    <div>
                        <div class="h4 mb-0 font-weight-700" style="font-size:1rem;">{{ number_format($ventas->VentaMaxima ?? 0) }}</div>
        ...
        <div class="col-6 col-md-4 col-xl-2 mb-3">
            <div class="card border-0 h-100">
                <div class="card-body d-flex align-items-center p-3">
                    ...
                    <div>
                        <div class="h4 mb-0 font-weight-700">{{ ceil($ventas->promedioTiempoEnDias ?? 0) }}</div>
        ...
        <div class="col-6 col-md-3 mb-3">
            <div class="card border-0 h-100">
                <div class="card-body d-flex align-items-center p-3">
                    ...
                    <div>
                        <div class="h4 mb-0 font-weight-700">{{ $contactos->CantidadContactos ?? 0 }}</div>
                ...
                <div class="card-footer bg-transparent border-top px-3 py-2">
                    <a href="{{ route('clientes.index') }}" class="text-xs text-primary">
        ...
        <div class="col-6 col-md-3 mb-3">
            <div class="card border-0 h-100">
                <div class="card-body d-flex align-items-center p-3">
                    ...
                    <div>
                        <div class="h4 mb-0 font-weight-700">{{ $pctAltas }}%</div>
                        <div class="text-xs text-muted font-weight-500 text-uppercase">Prob. altas</div>
                    </div>
                </div>
                <div class="card-footer bg-transparent border-top px-3 py-2">
                    <span class="text-xs text-success">
                        <i class="fas fa-user-check mr-1"></i>{{ $contactos_altas->CantidadContactos ?? 0 }} contactos
                    </span>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        new Chart(document.getElementById('myChart1'), pieConfig(
            {{ Js::from($labels_fuente_de_las_ventas) }},
            {{ Js::from($data_fuente_de_las_ventas) }}
        ));

        new Chart(document.getElementById('myChart2'), pieConfig(
            {{ Js::from($labels_zona_de_las_ventas) }},
            {{ Js::from($data_zona_de_las_ventas) }}
        ));

        new Chart(document.getElementById('myChart3'), barConfig(
            {{ Js::from($labels_ventas_por_mes) }},
            {{ Js::from($data_ventas_por_mes) }},
            '# de ventas'
        ));

        new Chart(document.getElementById('myChart4'), pieConfig(
            {{ Js::from($labels_tipo_de_las_ventas) }},
            {{ Js::from($data_tipo_de_las_ventas) }},
            'doughnut'
        ));

        new Chart(document.getElementById('myChart5'), pieConfig(
            {{ Js::from($labels_estado_de_las_ventas) }},
            {{ Js::from($data_estado_de_las_ventas) }},
            'doughnut'
        ));

        new Chart(document.getElementById('myChart6'), barConfig(
            {{ Js::from($labels_ventas_por_mes_monto) }},
            {{ Js::from($data_ventas_por_mes_monto) }},
            '$ vendido'
        ));
    </script>
