<div>
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        <div>
            ...
            <h1 class="section-title mb-0"><?php echo e($tipo->tipo); ?></h1>
        </div>
    </div>
    <!-- GRID -->
    <div class="row g-4">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-12">
                <div class="empty-state">
                    ...
                    <p>No hay propiedades disponibles de este tipo por el momento.</p>
                </div>
            </div>
        <?php endif; ?>
    </div>
...
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\livewire\buscar-propiedades-por-tipos.blade.php ENDPATH**/ ?>