...
<head>
    ...
    <title><?php echo e($propiedad->titulo); ?></title>
    <meta name="keywords" content="<?php echo e($inmo->palabrasclaves); ?>" />
    <meta name="description" content="<?php echo e($propiedad->metadescription); ?>">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="ltn__top-bar-menu">
                            <ul>
                                <li><a href=""><i class="icon-mail"></i><?php echo e($inmo->correo); ?></a></li>
                                <li><a href=""><i class="icon-placeholder"></i><?php echo e($inmo->direccion); ?></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5">
                        ...
                        <div class="header-menu d-none d-xl-block">
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        <li class="menu-icon"><a href=" <?php echo e(route("home")); ?> ">Home</a>                                          
                                        </li>
                                        <li class="menu-icon"><a href="<?php echo e(route("listapropiedades")); ?>">Propiedades</a>
                                        </li>
                                        <li class="menu-icon"><a href="<?php echo e(route("equipo")); ?>">Agentes</a>
                                        </li>                                        
                                        <li class="menu-icon"><a href="<?php echo e(route("quienessomos")); ?>">Quienes Somos</a>
                                        </li>
                                        <li class="menu-icon"><a href="<?php echo e(route("blog")); ?>">Novedades</a>
                                        </li>
                                        <li class="menu-icon"><a href="<?php echo e(route("contactos")); ?>">Contactos</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
...
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\layout\encabezadoPropiedad.blade.php ENDPATH**/ ?>