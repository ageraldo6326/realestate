            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                ...
                <section class="card venta-panel mb-4">
                    <div class="card-body">
                                            ...
                                            <?php $__empty_2 = true; $__currentLoopData = $propiedades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $propiedad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <tr>
                                                    <td class="font-weight-bold text-primary">
                                                        <?php echo e($propiedad->referencia); ?></td>
                                                    <td>
                                                        <img src="<?php echo e($propiedad->foto_portada); ?>"
                                                            alt="<?php echo e($propiedad->titulo); ?>"
                                                            style="width:48px;height:48px;object-fit:cover;border-radius:.5rem;">
                                                    </td>
                                                    <td><?php echo e($propiedad->titulo); ?></td>
                                                    <td>
                                                        <button class="btn btn-outline-primary btn-sm"
                                                            wire:click.prevent="buscarpropiedad('<?php echo e($propiedad->referencia); ?>')">
                                                            Seleccionar
                                                        </button>
                                                    </td>
                                                </tr>
                        ...
                        <?php if($tituloPropiedad): ?>
                            <div class="venta-selected-badge mb-3">
                                <span class="badge-id"><?php echo e($refPropiedad); ?></span>
                                <span class="font-weight-bold"><?php echo e($tituloPropiedad); ?></span>
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <section class="card venta-panel">
                    <div class="card-body">
                            ...
                            <?php if($criterioVendedor != ''): ?>
                                <div class="venta-search-results mt-1">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <?php $__empty_2 = true; $__currentLoopData = $vendedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <tr>
                                                    <td class="text-muted small"><?php echo e($vendedor->id); ?></td>
                                                    <td class="font-weight-bold"><?php echo e($vendedor->nombre); ?></td>
                                                    <td><?php echo e($vendedor->telefono); ?></td>
                                                    <td>
                                                        <button class="btn btn-outline-primary btn-sm"
                                                            wire:click.prevent="buscarvendedor('<?php echo e($vendedor->id); ?>')">
                                                            Seleccionar
                                                        </button>
                                                    </td>
                                                </tr>
                        ...
                        <?php if($nombre_vendedor): ?>
                            <div class="venta-selected-badge mb-3">
                                <span class="badge-id"><?php echo e($id_vendedor); ?></span>
                                <span class="font-weight-bold"><?php echo e($nombre_vendedor); ?></span>
                            </div>
                        <?php endif; ?>
            ...
            <div class="col-lg-6">
                ...
                <section class="card venta-panel mb-4">
                    <div class="card-body">
                            ...
                            <?php if($criterioComprador != ''): ?>
                                <div class="venta-search-results mt-1">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <?php $__empty_2 = true; $__currentLoopData = $compradores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comprador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <tr>
                                                    <td class="text-muted small"><?php echo e($comprador->id); ?></td>
                                                    <td class="font-weight-bold"><?php echo e($comprador->nombre); ?></td>
                                                    <td><?php echo e($comprador->telefono); ?></td>
                                                    <td class="text-muted small">
                                                        <?php echo e($comprador->created_at->format('d/m/Y')); ?></td>
                                                    <td>
                                                        <button class="btn btn-outline-primary btn-sm"
                                                            wire:click.prevent="buscarcomprador('<?php echo e($comprador->id); ?>')">
                                                            Seleccionar
                                                        </button>
                                                    </td>
                                                </tr>
                        ...
                        <?php if($nombre_comprador): ?>
                            <div class="venta-selected-badge mb-3">
                                <span class="badge-id"><?php echo e($id_comprador); ?></span>
                                <span class="font-weight-bold"><?php echo e($nombre_comprador); ?></span>
                                <?php if($medio_comprador): ?>
                                    <span class="small text-muted ml-2"><i
                                            class="fas fa-share-alt mr-1"></i><?php echo e($medio_comprador); ?></span>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <section class="card venta-panel mb-4">
                    <div class="card-body">
                        ...
                        <?php if($nombre_asesor): ?>
                            <div class="venta-selected-badge mb-3">
                                <i class="fas fa-user-tie text-primary"></i>
                                <span class="font-weight-bold"><?php echo e($nombre_asesor); ?></span>
                                <span class="small text-muted"><?php echo e($id_asesor); ?></span>
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-end">
                    <a href="<?php echo e(route('registrarventa')); ?>" class="btn btn-outline-secondary px-4 mr-2">
                        Cancelar
                    </a>
...
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\livewire\crear-ventas.blade.php ENDPATH**/ ?>