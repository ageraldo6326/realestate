<div>
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        <div>
            ...
            <h1 class="section-title mb-0"><?php echo e($zona->zona); ?></h1>
        </div>
    </div>
    <!-- GRID -->
    <div class="row g-4">
...
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\livewire\buscar-propiedades-por-zonas.blade.php ENDPATH**/ ?>