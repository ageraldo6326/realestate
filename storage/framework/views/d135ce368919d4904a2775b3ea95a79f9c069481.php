            ...
            <div class="modal-header border-0 pb-0 px-4 pt-4"
                ...
                <div>
                    <div class="text-uppercase small" style="color: rgba(255,255,255,.65); letter-spacing: .06em;">
                        <?php echo e($Id > 0 ? 'Edicion de contacto' : 'Nuevo contacto'); ?>

                    </div>
                    <h4 class="modal-title mb-0 text-white">
                        <?php echo e($Id > 0 ? 'ID: ' . $Id : 'Registrar contacto'); ?>
...
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\components\modalheader.blade.php ENDPATH**/ ?>