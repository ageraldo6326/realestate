...
} elseif ($_instance->childHasBeenRendered('wdi6srH')) {
    $componentId = $_instance->getRenderedChildComponentId('wdi6srH');
    $componentTag = $_instance->getRenderedChildComponentTagName('wdi6srH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wdi6srH');
} else {
    $response = \Livewire\Livewire::mount('buscar-propiedad');
    $html = $response->html();
    $_instance->logRenderedChild('wdi6srH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
