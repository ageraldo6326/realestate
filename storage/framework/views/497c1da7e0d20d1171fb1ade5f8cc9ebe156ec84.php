...
<?php $__env->startSection('title', 'Importar Contactos'); ?>
...
<?php $__env->startSection('page_title', 'Importar Contactos'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($errors->any() && !$errors->has('document_csv')): ?>
                            <div class="alert alert-danger border-0 shadow-sm">
                                Revisa el archivo e intenta nuevamente.
                            </div>
                        <?php endif; ?>

                        <form method="POST" action="<?php echo e(route('import.csv')); ?>" enctype="multipart/form-data" novalidate>
                            <?php echo csrf_field(); ?>
                ...
                <div class="card import-panel h-100">
                    <div class="card-body p-4">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                            ...
                            <a href="<?php echo e(route('import.template')); ?>" class="btn btn-outline-success btn-sm">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\admin\clientes\importContacto.blade.php ENDPATH**/ ?>