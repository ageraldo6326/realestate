            ...
            <div class="card-body p-4">
                ...
                <div class="table-responsive">
                    <table class="table align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $portadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $portada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="font-weight-semibold"><?php echo e($portada->id); ?></td>
                                    <td>
                                        <img src="<?php echo e(asset('assets/' . $portada->foto)); ?>" class="content-thumb" alt="<?php echo e($portada->titulo); ?>">
                                    </td>
                                    <td><?php echo e($portada->titulo); ?></td>
                                    <td class="text-right">
                                        <button type="button" class="btn btn-outline-primary btn-sm mr-1" wire:click="edit(<?php echo e($portada->id); ?>)" data-toggle="modal" data-target="#modalForm">Editar</button>
                                        <button type="button" class="btn btn-outline-danger btn-sm" wire:click="$emit('generarBorrarPortadaSweetAlert', <?php echo e($portada->id); ?>)">Borrar</button>
                                    </td>
                                </tr>
                ...
                <div class="mt-4"><?php echo e($portadas->links()); ?></div>
            </div>
        </section>
    </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header border-0 pb-0 px-4 pt-4">
                    <div>
                        <div class="text-uppercase small text-muted"><?php echo e($Id ? 'Edicion' : 'Nueva portada'); ?></div>
                        <h4 class="modal-title mb-0"><?php echo e($Id ? 'Editar portada' : 'Registrar portada'); ?></h4>
                    </div>
                            ...
                            <div class="card content-panel mb-4">
                                <div class="card-body p-4">
                                    ...
                                    <div class="form-group mb-0" wire:ignore>
                                        ...
                                        <textarea class="form-control" id="descripcion-portada" rows="8"><?php echo e($descripcion); ?></textarea>
                                    </div>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php if($coverPreview): ?>
                                        <img class="media-preview mb-3" src="<?php echo e($coverPreview); ?>" alt="Preview portada">
                                        <div>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <?php if($videoPreview): ?>
                                        <div class="embed-responsive embed-responsive-16by9 rounded-lg overflow-hidden shadow-sm">
                                            <iframe class="embed-responsive-item" src="<?php echo e($videoPreview); ?>" allowfullscreen></iframe>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-0">
                    ...
                    <button type="button" class="btn btn-primary px-4" <?php if($Id == 0): ?> wire:click.prevent="store" <?php else: ?> wire:click.prevent="update(<?php echo e($Id); ?>)" <?php endif; ?>>
                        <?php echo e($Id ? 'Actualizar portada' : 'Guardar portada'); ?>
    ...
    <script>
        document.addEventListener('livewire:load', () => {
            ...
            const ensurePortadaEditor = () => window.AdminCkeditor?.ensure(selector, (value) => {
                window.livewire.find('<?php echo e($_instance->id); ?>').set('descripcion', value);
            });
...
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\livewire\buscar-portada.blade.php ENDPATH**/ ?>