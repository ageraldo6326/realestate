...
} elseif ($_instance->childHasBeenRendered('OwmmKRO')) {
    $componentId = $_instance->getRenderedChildComponentId('OwmmKRO');
    $componentTag = $_instance->getRenderedChildComponentTagName('OwmmKRO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OwmmKRO');
} else {
    $response = \Livewire\Livewire::mount('propiedades-por-agentes', ['id_agente' => $id_agente]);
    $html = $response->html();
    $_instance->logRenderedChild('OwmmKRO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
