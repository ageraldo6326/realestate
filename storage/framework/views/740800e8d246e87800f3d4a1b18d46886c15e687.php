            ...
            <table class="table mt-0 rounded border table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo e($propiedad->foto_portada); ?>" class="" height="50rem" width="100rem"
                                alt=""></td>
                        <td><?php echo e($propiedad->titulo); ?></td>
                        <td class="d-none d-md-table-cell"><?php echo e($propiedad->zona); ?></td>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-12">
                                    <form method="GET" action="<?php echo e(route("editarpendientes",$propiedad->id)); ?>">
