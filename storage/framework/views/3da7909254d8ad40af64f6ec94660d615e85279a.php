...
<?php $__env->startSection('page_title', 'Inventario disponible'); ?>
            ...
            <div class="card-body py-4" style="background: linear-gradient(135deg, #0f172a, #1d4ed8); color: #ffffff;">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="<?php echo e(route('propiedades.index')); ?>" class="btn btn-light btn-sm">
                            <i class="fas fa-building mr-1"></i> Mis propiedades
                        </a>
                        <?php if($isAdmin): ?>
                            <a href="<?php echo e(route('asignar')); ?>" class="btn btn-outline-light btn-sm">
                                <i class="fas fa-user-check mr-1"></i> Asignar contacto
                            </a>
                            <a href="<?php echo e(route('import.index')); ?>" class="btn btn-outline-light btn-sm">
                                <i class="fas fa-file-import mr-1"></i> Importar contactos
                            </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('propiedades.create')); ?>" class="btn btn-outline-light btn-sm">
...
} elseif ($_instance->childHasBeenRendered('DNjntks')) {
    $componentId = $_instance->getRenderedChildComponentId('DNjntks');
    $componentTag = $_instance->getRenderedChildComponentTagName('DNjntks');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DNjntks');
} else {
    $response = \Livewire\Livewire::mount('mostrar-inventario');
    $html = $response->html();
    $_instance->logRenderedChild('DNjntks', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php echo $__env->make('admin.layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\admin\inventario\index.blade.php ENDPATH**/ ?>