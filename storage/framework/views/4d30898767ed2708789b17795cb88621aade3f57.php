    ...
    <div class="col-12">
        ...
        <form action="<?php echo e(route("propiedades.update",$propiedad->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" value="<?php echo e($propiedad->titulo); ?>"  placeholder="Titulo" required maxlength="60">
            </div>

            <div class="form-group">
                <label for="descripcion_corta">Descripción corta</label>
                <input type="text" class="form-control" id="descripcion_corta" value="<?php echo e($propiedad->descripcion_corta); ?>" name="descripcion_corta" placeholder="Descripción corta" required maxlength="160">
            </div>            
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Meta Description" id="metadescription" name="metadescription" maxlength="160" style="height: 100px"><?php echo e($propiedad->metadescription); ?></textarea>
            </div>
                ...
                <div class="card-body">            
                    <div class="row">
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="file" id="foto1" name="foto1" value="<?php echo e($propiedad->foto1); ?>">
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="file" id="foto2" name="foto2"  value="<?php echo e($propiedad->foto2); ?>">
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="file" id="foto3" name="foto3" value="<?php echo e($propiedad->foto3); ?>">
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="file" id="foto4" name="foto4" value="<?php echo e($propiedad->foto4); ?>">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="file" id="foto5" name="foto5" value="<?php echo e($propiedad->foto5); ?>">
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="file" id="foto6" name="foto6" value="<?php echo e($propiedad->foto6); ?>">
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="file" id="foto7" name="foto7" value="<?php echo e($propiedad->foto7); ?>">
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="file" id="foto8" name="foto8" value="<?php echo e($propiedad->foto8); ?>">
                ...
                <div class="card-body"> 
                    <div class="row">           
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="text" id="video1" name="video1" value="<?php echo e($propiedad->video1); ?>">
                        </div>
                    </div>
                </div>
            </div>            
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="precio" name="precio" required placeholder="Precio" value="<?php echo e($propiedad->precio); ?>">
                    </div>
                </div>                
                ...
                <div class="col-2">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="disponible_para" id="disponible_para" required>
                            <option selected>Disponible para</option>
                            <?php $__empty_1 = true; $__currentLoopData = $disponibles_para; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disponible_para): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <option <?php if($propiedad->disponible_para==$disponible_para->id): ?> selected <?php endif; ?> value="<?php echo e($disponible_para->id); ?>"><?php echo e($disponible_para->disponible_para); ?></option>
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="metraje" name="metraje" placeholder="Metraje" value="<?php echo e($propiedad->metraje); ?>" required>
                    </div>
                </div>  
                ...
                <div class="col-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="metraje_construccion" name="metraje_construccion" placeholder="Metraje de Construcción" value="<?php echo e($propiedad->metraje_construccion); ?>">
                    </div>
                </div>                

                <div class="col-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" <?php if($propiedad->destacada==1): ?> checked <?php endif; ?> id="destacada" name="destacada">
                ...
                <div class="col-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" <?php if($propiedad->vendida==1): ?> checked <?php endif; ?> id="vendida" name="vendida">
                ...
                <div class="col-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" <?php if($propiedad->activa==1): ?> checked <?php endif; ?> id="activa"
                        name="activa">
...
<div class="card">
    ...
    <div class="row">
                ...
                <div class="col-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" <?php if($propiedad->lobby==1): ?> checked <?php endif; ?> id="lobby" name="lobby">
                ...
                <div class="col-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" <?php if($propiedad->plantaelectrica==1): ?> checked <?php endif; ?> id="plantaelectrica" name="plantaelectrica">
                ...
                <div class="col-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" <?php if($propiedad->camaravigilancia==1): ?> checked <?php endif; ?> id="camaravigilancia" name="camaravigilancia">
                ...
                <div class="col-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" <?php if($propiedad->escaleraemergencia==1): ?> checked <?php endif; ?> id="escaleraemergencia" name="escaleraemergencia">
                ...
                <div class="col-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" <?php if($propiedad->maderapreciosa==1): ?> checked <?php endif; ?> id="maderapreciosa" name="maderapreciosa">
                ...
                <div class="col-2">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" <?php if($propiedad->balcon==1): ?> checked <?php endif; ?> id="balcon" name="balcon">
...
<div class="row">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->walkincloset==1): ?> checked <?php endif; ?> id="walkincloset" name="walkincloset">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->jacuzzi==1): ?> checked <?php endif; ?> id="jacuzzi" name="jacuzzi">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->areainfantil==1): ?> checked <?php endif; ?> id="areainfantil" name="areainfantil">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->banovisitas==1): ?> checked <?php endif; ?> id="banovisitas" name="banovisitas">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->cisterna==1): ?> checked <?php endif; ?> id="cisterna" name="cisterna">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->inversorareacomun==1): ?> checked <?php endif; ?> id="inversorareacomun" name="inversorareacomun">
...
<div class="row">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->gascomun==1): ?> checked <?php endif; ?> id="gascomun" name="gascomun">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->gazebo==1): ?> checked <?php endif; ?> id="gazebo" name="gazebo">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->pozo==1): ?> checked <?php endif; ?> id="pozo" name="pozo">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->piscina==1): ?> checked <?php endif; ?> id="piscina" name="piscina">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->familyroom==1): ?> checked <?php endif; ?> id="familyroom" name="familyroom">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->cuartodeservicio==1): ?> checked <?php endif; ?> id="cuartodeservicio" name="cuartodeservicio">
...
<div class="row">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->patio==1): ?> checked <?php endif; ?> id="patio" name="patio">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->portonelectrico==1): ?> checked <?php endif; ?> id="portonelectrico" name="portonelectrico">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->seguridad24horas==1): ?> checked <?php endif; ?> id="seguridad24horas" name="seguridad24horas">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->ascensor==1): ?> checked <?php endif; ?> id="ascensor" name="ascensor">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->parqueostechados==1): ?> checked <?php endif; ?> id="parqueostechados" name="parqueostechados">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->preinstalacionairetinacoinversor==1): ?> checked <?php endif; ?> id="preinstalacionairetinacoinversor" name="preinstalacionairetinacoinversor">
...
<div class="row">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->terraza==1): ?> checked <?php endif; ?> id="terraza" name="terraza">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->estudio==1): ?> checked <?php endif; ?> id="estudio" name="estudio">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->gimnasio==1): ?> checked <?php endif; ?> id="gimnasio" name="gimnasio">
    ...
    <div class="col-2">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" <?php if($propiedad->controldeacceso==1): ?> checked <?php endif; ?> id="controldeacceso" name="controldeacceso">
...
<?php echo $__env->make('admin.layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\admin\clientes\ver.blade.php ENDPATH**/ ?>