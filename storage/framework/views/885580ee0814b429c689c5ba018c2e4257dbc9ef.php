            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="catalog-stat">
                        ...
                        <div class="h3 mb-0 font-weight-bold"><?php echo e($disponiblespara->total()); ?></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="card catalog-panel">
            <div class="card-body p-4">
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center mb-4">
                    ...
                    <a href="<?php echo e(route('disponiblepara.create')); ?>" class="btn btn-primary mt-3 mt-lg-0 px-4">
                        Nuevo registro
                    </a>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $disponiblespara; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disponiblepara): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="font-weight-semibold"><?php echo e($disponiblepara->id); ?></td>
                                    <td><?php echo e($disponiblepara->disponible_para); ?></td>
                                    <td class="d-none d-md-table-cell text-muted small"><?php echo e($disponiblepara->created_at); ?></td>
                                    <td class="text-right">
                                        <a href="<?php echo e(route('disponiblepara.edit', $disponiblepara->id)); ?>"
                                            class="btn btn-outline-primary btn-sm mr-1">
                                            Editar
                                        </a>
                                        <button type="button" class="btn btn-outline-danger btn-sm"
                                            wire:click="$emit('generarBorrarDisponibleParaSweetAlert', <?php echo e($disponiblepara->id); ?>)">
                                            Borrar
                                        </button>
                                    </td>
                                </tr>
...
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\livewire\buscar-disponible-para.blade.php ENDPATH**/ ?>