...
<?php $__env->startSection('seo_title', 'Contacto — ' . ($inmo->titulo ?? 'Portal Inmobiliario')); ?>
<?php $__env->startSection('seo_description', 'Contáctanos para más información sobre nuestras propiedades. Estamos aquí para ayudarte.'); ?>
...
<section class="contact-section">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            <?php if(isset($inmobiliaria->correo) && $inmobiliaria->correo): ?>
            <div class="col-lg-4 col-md-6">
                <div class="contact-info-card">
                    <div class="contact-icon"><i class="fas fa-envelope"></i></div>
                    <h3>Correo Electrónico</h3>
                    <p><a href="mailto:<?php echo e($inmobiliaria->correo); ?>"><?php echo e($inmobiliaria->correo); ?></a></p>
                </div>
            </div>
            <?php endif; ?>
            <?php if(isset($inmobiliaria->telefono) && $inmobiliaria->telefono): ?>
            <div class="col-lg-4 col-md-6">
                <div class="contact-info-card">
                    <div class="contact-icon"><i class="fas fa-phone"></i></div>
                    <h3>Teléfono</h3>
                    <p><a href="tel:<?php echo e($inmobiliaria->telefono); ?>"><?php echo e($inmobiliaria->telefono); ?></a></p>
                </div>
            </div>
            <?php endif; ?>
            <?php if(isset($inmobiliaria->direccion) && $inmobiliaria->direccion): ?>
            <div class="col-lg-4 col-md-6">
                <div class="contact-info-card">
                    <div class="contact-icon"><i class="fas fa-location-dot"></i></div>
                    <h3>Dirección</h3>
                    <p><?php echo e($inmobiliaria->direccion); ?></p>
                </div>
            </div>
            <?php endif; ?>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.layout-landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views/frontend/contacto.blade.php ENDPATH**/ ?>