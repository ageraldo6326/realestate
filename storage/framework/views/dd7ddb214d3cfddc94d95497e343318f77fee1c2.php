                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php if($post->foto): ?><img src="<?php echo e(asset('assets/' . $post->foto)); ?>" class="content-thumb" alt="<?php echo e($post->titulo); ?>"><?php endif; ?></td>
                                    <td><?php echo e($post->titulo); ?></td>
                                    <td class="d-none d-md-table-cell text-muted small"><?php echo e($post->created_at); ?></td>
                                    <td class="text-right">
                                        <button type="button" class="btn btn-outline-primary btn-sm mr-1" wire:click="edit(<?php echo e($post->id); ?>)" data-toggle="modal" data-target="#modalForm">Editar</button>
                                        <button type="button" class="btn btn-outline-danger btn-sm" wire:click="$emit('generarBorrarPostSweetAlert', <?php echo e($post->id); ?>)">Borrar</button>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header border-0 pb-0 px-4 pt-4">
                    <div>
                        <div class="text-uppercase small text-muted"><?php echo e($Id ? 'Edicion' : 'Nuevo post'); ?></div>
                        <h4 class="modal-title mb-0"><?php echo e($Id ? 'Editar post' : 'Registrar post'); ?></h4>
                    </div>
                            ...
                            <div class="card content-panel mb-4">
                                <div class="card-body p-4">
                                    ...
                                    <div class="form-group mb-0" wire:ignore>
                                        ...
                                        <textarea class="form-control" id="contenido-post" rows="10"><?php echo e($contenido); ?></textarea>
                                    </div>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php if($photoPreview): ?>
                                        <img class="media-preview mb-3" src="<?php echo e($photoPreview); ?>" alt="Imagen post">
                                        <div>
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-0">
                    ...
                    <button type="button" class="btn btn-primary px-4" <?php if($Id == 0): ?> wire:click.prevent="store" <?php else: ?> wire:click.prevent="update(<?php echo e($Id); ?>)" <?php endif; ?>>
                        <?php echo e($Id ? 'Actualizar post' : 'Guardar post'); ?>
    ...
    <script>
        document.addEventListener('livewire:load', () => {
            ...
            const ensurePostEditor = () => window.AdminCkeditor?.ensure(selector, (value) => {
                window.livewire.find('<?php echo e($_instance->id); ?>').set('contenido', value);
            });
...
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\livewire\buscar-post.blade.php ENDPATH**/ ?>