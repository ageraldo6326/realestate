...
<section class="page-hero" aria-label="Artículo">
    <div class="container">
        <h1 class="page-hero-title"><?php echo e($post->titulo); ?></h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>">Inicio</a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(route('blog')); ?>">Novedades</a></li>
            ...
            <div class="col-lg-10">
                <article class="post-card">
                    ...
                    <div class="post-footer">
                        <a href="<?php echo e(route('blog')); ?>" class="btn-primary-solid">
