...
} elseif ($_instance->childHasBeenRendered('bMQrfGe')) {
    $componentId = $_instance->getRenderedChildComponentId('bMQrfGe');
    $componentTag = $_instance->getRenderedChildComponentTagName('bMQrfGe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bMQrfGe');
} else {
    $response = \Livewire\Livewire::mount('buscar-propiedades-home');
    $html = $response->html();
    $_instance->logRenderedChild('bMQrfGe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
