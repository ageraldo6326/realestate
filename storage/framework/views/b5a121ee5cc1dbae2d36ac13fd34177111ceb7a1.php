...
<?php $__env->startSection('critical_preloads'); ?>
...
} elseif ($_instance->childHasBeenRendered('xIItyAl')) {
    $componentId = $_instance->getRenderedChildComponentId('xIItyAl');
    $componentTag = $_instance->getRenderedChildComponentTagName('xIItyAl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xIItyAl');
} else {
    $response = \Livewire\Livewire::mount('buscar-propiedades-home');
    $html = $response->html();
    $_instance->logRenderedChild('xIItyAl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
