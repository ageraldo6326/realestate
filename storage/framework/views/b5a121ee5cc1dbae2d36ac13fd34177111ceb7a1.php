...
} elseif ($_instance->childHasBeenRendered('xJ6Ls9y')) {
    $componentId = $_instance->getRenderedChildComponentId('xJ6Ls9y');
    $componentTag = $_instance->getRenderedChildComponentTagName('xJ6Ls9y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xJ6Ls9y');
} else {
    $response = \Livewire\Livewire::mount('buscar-propiedades-home');
    $html = $response->html();
    $_instance->logRenderedChild('xJ6Ls9y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
