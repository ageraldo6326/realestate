...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid modern-property-create py-4">
        <section class="create-hero mb-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <?php if($isAdmin): ?>
                        <a href="<?php echo e(route('asignar')); ?>" class="btn btn-outline-light">
                            Asignar contacto
                        </a>
                        <a href="<?php echo e(route('import.index')); ?>" class="btn btn-light text-dark border-0">
                            Importar contactos
                        </a>
                    <?php endif; ?>
                </div>
        ...
        <form action="<?php echo e(route('propiedades.store')); ?>" method="POST" enctype="multipart/form-data" novalidate>
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    id="titulo" name="titulo" value="<?php echo e(old('titulo')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    id="descripcion_corta" value="<?php echo e(old('descripcion_corta')); ?>" name="descripcion_corta"
...
unset($__errorArgs, $__bag); ?>" id="descripcion" name="descripcion"
                                    rows="10" placeholder="Describe distribucion, entorno, acabados y beneficios" required><?php echo e(old('descripcion')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>" id="direccion" name="direccion" maxlength="200"
                                    rows="3" placeholder="Direccion referencial de la propiedad"><?php echo e(old('direccion')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="provincia"
                                        ...
                                        <?php $__currentLoopData = $provincias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provincia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($provincia->id); ?>"
                                                <?php echo e(old('provincia') == $provincia->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="sector_id"
                                        ...
                                        <?php $__currentLoopData = $sectores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sector->id); ?>"
                                                ...
                                                <?php echo e(old('sector_id') == $sector->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="RD$" <?php echo e(old('tipomoneda', 'RD$') === 'RD$' ? 'selected' : ''); ?>>
                                            RD$</option>
                                        <option value="US$" <?php echo e(old('tipomoneda') === 'US$' ? 'selected' : ''); ?>>US$
                                        </option>
                                    </select>
                                </div>
...
unset($__errorArgs, $__bag); ?>" id="comision"
                                        name="comision" placeholder="Ej: 3.5" value="<?php echo e(old('comision')); ?>">
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="tipo"
                                        ...
                                        <?php $__currentLoopData = $tipos_propiedades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipos_propiedad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($tipos_propiedad->id); ?>"
                                                <?php echo e(old('tipo') == $tipos_propiedad->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $disponibles_para; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disponible_para): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($disponible_para->id); ?>"
                                                <?php echo e(old('disponible_para') == $disponible_para->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $estados_propiedad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado_propiedad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($estado_propiedad->id); ?>"
                                                <?php echo e(old('estadopropiedad') == $estado_propiedad->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php for($i = 0; $i <= 5; $i++): ?>
                                            <option value="<?php echo e($i); ?>"
                                                <?php echo e(old('habitaciones') == (string) $i ? 'selected' : ''); ?>>
                                                <?php echo e($i); ?></option>
                                        <?php endfor; ?>
                                    </select>
                                </div>
...
unset($__errorArgs, $__bag); ?>" name="banos"
                                        ...
                                        <?php $__currentLoopData = ['0', '1', '1.5', '2', '2.5', '3', '3.5', '4', '4.5', '5', '5.5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($banio); ?>"
                                                <?php echo e(old('banos') == $banio ? 'selected' : ''); ?>><?php echo e($banio); ?>
...
unset($__errorArgs, $__bag); ?>" name="parqueos"
                                        ...
                                        <?php for($i = 0; $i <= 5; $i++): ?>
                                            <option value="<?php echo e($i); ?>"
                                                <?php echo e(old('parqueos') == (string) $i ? 'selected' : ''); ?>><?php echo e($i); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('metraje')); ?>" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('metraje_construccion')); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex flex-wrap gap-2 mb-3">
                                <label class="toggle-chip">
                                    <input type="checkbox" name="destacada" id="destacada"
                                        <?php echo e(old('destacada') ? 'checked' : ''); ?>>
                                    <span>Destacada</span>
                                </label>
                                <label class="toggle-chip">
                                    <input type="checkbox" name="vendida" id="vendida"
                                        <?php echo e(old('vendida') ? 'checked' : ''); ?>>
                                    <span>Vendida</span>
                                </label>
                                <label class="toggle-chip">
                                    <input type="checkbox" name="marcadeagua" id="marcadeagua"
                                        <?php echo e(old('marcadeagua', 0) ? 'checked' : ''); ?>>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div id="dropzone-portada"
                                    class="dropzone-container dropzone-cover <?php $__errorArgs = ['foto_portada'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input class="form-control" type="text" id="video1" name="video1"
                                    value="<?php echo e(old('video1')); ?>" placeholder="https://www.youtube.com/watch?v=...">
...
unset($__errorArgs, $__bag); ?>" id="metadescription"
                                    ...
                                    placeholder="Descripcion para buscadores (20-160 caracteres)"><?php echo e(old('metadescription')); ?></textarea>
...
<?php echo $__env->make('admin.layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\admin\propiedades\create.blade.php ENDPATH**/ ?>