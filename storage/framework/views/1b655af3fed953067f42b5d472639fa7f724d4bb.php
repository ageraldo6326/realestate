    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form action="<?php echo e(route('updatecualquiera', $propiedad->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <select class="form-control" name="tipo" id="tipo" required>
                                    ...
                                    <?php $__currentLoopData = $tipos_propiedades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipos_propiedad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($propiedad->tipo == $tipos_propiedad->id): ?> selected <?php endif; ?>
                                            value="<?php echo e($tipos_propiedad->id); ?>"><?php echo e($tipos_propiedad->tipo); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                                ...
                                <select class="form-control" name="disponible_para" id="disponible_para" required>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $disponibles_para; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disponible_para): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option <?php if($propiedad->disponible_para == $disponible_para->id): ?> selected <?php endif; ?>
                                            value="<?php echo e($disponible_para->id); ?>"><?php echo e($disponible_para->disponible_para); ?>
                                ...
                                <select class="form-control" name="estadopropiedad" id="estadopropiedad" required>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $estados_propiedad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado_propiedad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option <?php if($propiedad->estado_id == $estado_propiedad->id): ?> selected <?php endif; ?>
                                            value="<?php echo e($estado_propiedad->id); ?>"><?php echo e($estado_propiedad->estado); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <?php endif; ?>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input"
                                    <?php if($propiedad->destacada == 1): ?> checked <?php endif; ?> id="destacada" name="destacada">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input"
                                    <?php if($propiedad->vendida == 1): ?> checked <?php endif; ?> id="vendida" name="vendida">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input"
                                    <?php if($propiedad->activa == 1): ?> checked <?php endif; ?> id="activa" name="activa">
                        ...
                        <?php if((bool) optional($inmobiliaria)->aprobacion && $isAdmin): ?>
                            <div class="col-md-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input"
                                        <?php if($propiedad->aprobada == 1): ?> checked <?php endif; ?> id="aprobada" name="aprobada">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            <?php if($propiedad->camaravigilancia == 1): ?> checked <?php endif; ?> id="camaravigilancia"
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            <?php if($propiedad->escaleraemergencia == 1): ?> checked <?php endif; ?> id="escaleraemergencia"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            <?php if($propiedad->inversorareacomun == 1): ?> checked <?php endif; ?> id="inversorareacomun"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            <?php if($propiedad->cuartodeservicio == 1): ?> checked <?php endif; ?> id="cuartodeservicio"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            <?php if($propiedad->seguridad24horas == 1): ?> checked <?php endif; ?> id="seguridad24horas"
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            <?php if($propiedad->parqueostechados == 1): ?> checked <?php endif; ?> id="parqueostechados"
...
<?php echo $__env->make('admin.layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\admin\propiedades\editarpendientescualquiera.blade.php ENDPATH**/ ?>