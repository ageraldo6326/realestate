...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> | Alis CRM</title>
                ...
                <li class="nav-item d-none d-md-flex align-items-center">
                    <ol class="breadcrumb mb-0 bg-transparent p-0 pl-2">
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('dashboard')); ?>" class="text-muted"><i class="fas fa-home"></i></a>
                        </li>
...
} elseif ($_instance->childHasBeenRendered('OggvcIE')) {
    $componentId = $_instance->getRenderedChildComponentId('OggvcIE');
    $componentTag = $_instance->getRenderedChildComponentTagName('OggvcIE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OggvcIE');
} else {
    $response = \Livewire\Livewire::mount('theme-toggle');
    $html = $response->html();
    $_instance->logRenderedChild('OggvcIE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </li>
                ...
                <li class="nav-item d-none d-md-block">
                    <a href="<?php echo e(route('clientes.index')); ?>" class="nav-link text-muted" title="Contactos">
                        <i class="fas fa-users"></i>
                    </a>
                </li>
                <!-- Website público -->
                <li class="nav-item d-none d-md-block">
                    <a href="<?php echo e(url('/')); ?>" target="_blank" class="nav-link text-muted" title="Ver website">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow-sm border-0 mt-1"
                        ...
                        <div class="px-3 py-2 border-bottom">
                            <div class="font-weight-600 text-sm"><?php echo e(Auth::user()->name); ?></div>
                            <div class="text-muted text-xs"><?php echo e(Auth::user()->email); ?></div>
                        </div>
                        <a href="<?php echo e(route('usuarios.index')); ?>" class="dropdown-item py-2">
            ...
            <div class="content-header px-3 pt-3 pb-0">
                <div class="container-fluid px-0">
                    <div class="d-flex align-items-center justify-content-between">
                        <h1 class="h4 mb-0 font-weight-600"><?php echo $__env->yieldContent('page_title', ''); ?></h1>
        ...
        <footer class="main-footer py-2">
            <div class="d-flex justify-content-between align-items-center">
                <div class="text-muted text-sm">
                    <strong><?php echo e($inmo->empresa ?? 'Alis CRM'); ?></strong> &mdash; Sistema de gestión inmobiliaria
                </div>
                <div class="text-muted text-xs d-none d-sm-block">
                    v<?php echo e(config('app.version', '1.0')); ?> &bull; <?php echo e(now()->year); ?>
...
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views/admin/layoutadmin.blade.php ENDPATH**/ ?>