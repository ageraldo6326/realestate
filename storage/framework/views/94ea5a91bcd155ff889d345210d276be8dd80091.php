...
<div class="container-fluid px-3">
    <div class="content-form-shell">
        <section class="content-form-hero">
            <h2 class="h4 mb-2 font-weight-bold"><?php echo e($isEdit ? 'Editar post' : 'Nuevo post'); ?></h2>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('titulo', optional($postActual)->titulo)); ?>" maxlength="60" required>
                            </div>
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-outline-primary" id="btn-generar-ia-post">
                                    ...
                                    <span
                                        id="ia-post-label"><?php echo e($isEdit ? 'Regenerar con IA' : 'Generar contenido con IA'); ?></span>
                                </button>
                            </div>

                            <div class="form-group mb-0">
                                <label for="contenido-editor" class="content-form-label">Contenido</label>
                                <textarea class="form-control content-form-control <?php $__errorArgs = ['contenido'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="contenido-editor"
                                    name="contenido" rows="12"><?php echo e(old('contenido', optional($postActual)->contenido)); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card content-form-panel mb-4">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control content-form-control <?php $__errorArgs = ['seo_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('seo_title', optional($postActual)->seo_title)); ?>"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea class="form-control content-form-control <?php $__errorArgs = ['metadescription'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="metadescription"
                                    name="metadescription" rows="4" maxlength="160"><?php echo e(old('metadescription', optional($postActual)->metadescription)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4">
                    <div class="card content-form-panel mb-4">
                        <div class="card-body">
                            ...
                            <div id="post-dropzone-<?php echo e($mode); ?>"
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group mt-3">
                                ...
                                <input type="text" id="image_alt" name="image_alt" maxlength="160"
                                    ...
                                    value="<?php echo e(old('image_alt', optional($postActual)->image_alt)); ?>">
                            </div>
                            <div class="form-group mb-0">
                                ...
                                <input type="text" id="image_credit" name="image_credit" maxlength="160"
                                    class="form-control content-form-control"
                                    value="<?php echo e(old('image_credit', optional($postActual)->image_credit)); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if($currentImage): ?>
                        <div class="content-preview-card mb-4">
                            ...
                            <img src="<?php echo e($currentImage); ?>" alt="Imagen actual del post">
                        </div>
                    <?php endif; ?>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" id="published_at" name="published_at"
                                    class="form-control content-form-control"
                                    value="<?php echo e(old('published_at', optional(optional($postActual)->published_at)->format('Y-m-d\TH:i'))); ?>">
                            </div>
                            <div class="custom-control custom-switch">
                                <input class="custom-control-input" type="checkbox" id="activo" name="activo"
                                    value="1"
                                    <?php echo e(old('activo', optional($postActual)->activo ?? false) ? 'checked' : ''); ?>>
            ...
            <div class="content-submit-row">
                <a href="<?php echo e(route('posts.index')); ?>" class="btn btn-outline-secondary px-4">Cancelar</a>
                <button type="submit" class="btn btn-primary px-4 js-submit-button"
                    data-loading-text="Guardando..."><?php echo e($isEdit ? 'Guardar cambios' : 'Guardar post'); ?></button>
            </div>
        </form>
    </div>
</div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const target = document.getElementById('post-dropzone-<?php echo e($mode); ?>');
            ...
            button?.addEventListener('click', async () => {
                ...
                try {
                    ...
                    if (label) {
                        label.textContent =
                            '<?php echo e($isEdit ? 'Regenerar con IA' : 'Generar contenido con IA'); ?>';
                    }
                }
            });

            const form = document.getElementById('post-form-<?php echo e($mode); ?>');
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views/admin/posts/_form.blade.php ENDPATH**/ ?>