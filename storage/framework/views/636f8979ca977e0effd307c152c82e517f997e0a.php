...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('assets/'.$inmo->favicon)); ?>" type="image/x-icon" />
...
<div class="body-wrapper">
                    ...
                    <div class="col-md-7">
                        <div class="ltn__top-bar-menu">
                            <ul>
                                ...
                                <li><i class="icon-placeholder"></i><?php if(isset($inmo->direccion)): ?> <?php echo e($inmo->direccion); ?> <?php endif; ?></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col">
                        <div class="site-logo-wrap">
                            <div class="site-logo">
                                <a href=" <?php echo e(route("home")); ?> "><img loading="lazy" srcset=" <?php if(isset($inmo->telefono)): ?> <?php echo e(asset('assets/'.$inmo->logo)); ?>  <?php endif; ?> " alt="Logo"></a>
                            </div>
                        </div>
                    </div>
    ...
    <div id="ltn__utilize-mobile-menu" class="ltn__utilize ltn__utilize-mobile-menu">
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            <div class="ltn__utilize-menu-head">
                <div class="site-logo">                    
                    <a href=" <?php echo e(route("home")); ?> "><img loading="lazy" src=" <?php if(isset($inmo->telefono)): ?> <?php echo e('assets/'.$inmo->logo); ?> <?php endif; ?> " alt="Logo"></a>
                </div>
    ...
    <!-- SLIDER AREA START (slider-3) --><?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views/layout/encabezado.blade.php ENDPATH**/ ?>