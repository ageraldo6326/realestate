...
<div class="container-fluid px-3 empresa-shell">
    ...
    <div class="empresa-shell-wrap">
        <section class="empresa-hero">
            <div class="row align-items-end">
                <div class="col-lg-8 mb-3 mb-lg-0">
                    ...
                    <h1 class="h3 font-weight-bold mb-2"><?php echo e($isEdit ? 'Editar empresa' : 'Crear empresa'); ?></h1>
                ...
                <div class="col-lg-4">
                    <div class="empresa-stat">
                        ...
                        <div class="small text-white-50">
                            <?php echo e($isEdit ? 'Registro principal de empresa' : 'Configuracion inicial de empresa'); ?></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <form action="<?php echo e($action); ?>" method="post" enctype="multipart/form-data" novalidate>
            <?php echo csrf_field(); ?>
            <?php if($isEdit): ?>
                <?php echo method_field('PUT'); ?>
            <?php endif; ?>

            <?php echo $__env->make('admin.empresa.partials.form-fields', [
...
<?php if (! $__env->hasRenderedOnce('b3bc4cc9-d7df-4df9-bf9e-ffe8ecb5b70f')): $__env->markAsRenderedOnce('b3bc4cc9-d7df-4df9-bf9e-ffe8ecb5b70f'); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH D:\xampp3\htdocs\realestate_dev\resources\views\admin\empresa\_form.blade.php ENDPATH**/ ?>