            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="empresa-stat">
                        ...
                        <div class="h4 mb-1 font-weight-bold"><?php echo e($isEdit ? 'Edición' : 'Configuración inicial'); ?></div>
                        <div class="small text-white-50">
                            <?php echo e($isEdit ? 'Ajustes activos del portal' : 'Preparación inicial del portal'); ?></div>
                    </div>
                </div>
            </div>
        </section>
...
<?php if (! $__env->hasRenderedOnce('8e87363e-8fe1-4031-bd4e-9b840cfd7435')): $__env->markAsRenderedOnce('8e87363e-8fe1-4031-bd4e-9b840cfd7435'); ?>
