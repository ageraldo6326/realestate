...
class ContactosTodos extends Component
{
    ...
    public function render()
    {
        ...
        $user = CatalogoService::asesoresActivos();
        ...
        return view('livewire.contactos-todos', compact("clientes", "zonas", "tipos_propiedades", "estados_propiedad", "notas", "tareas", "tipos", "estatuses", "user"));
    }
