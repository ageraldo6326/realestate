...
class PublicHomePerformanceViewTest extends TestCase
{
    public function test_home_preloads_the_lcp_image_and_reserves_image_space(): void
    {
        ...
        $this->assertStringContainsString('content-visibility: auto', $home);
        ...
        $this->assertStringContainsString("asset('css/landing-shared-v1.min.css')", $header);
        ...
        $this->assertStringContainsString('requestAnimationFrame(() => requestAnimationFrame', $footer);
        $this->assertStringContainsString("asset('css/home-framework-v1.min.css')", $footer);
        $this->assertStringContainsString("asset('css/home-non-critical-v1.min.css')", $footer);
        $this->assertStringContainsString('cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css', $footer);
        ...
        $this->assertFileExists($root . '/public/css/home-framework-v1.min.css');
        $this->assertFileExists($root . '/public/css/landing-shared-v1.min.css');
        $this->assertFileExists($root . '/public/css/landing-footer-v1.min.css');
    ...
    public function test_static_assets_receive_safe_cache_lifetimes(): void
    {
        ...
        $this->assertStringContainsString('<Files "home-framework-v1.min.css">', $htaccess);
        $this->assertStringContainsString('<Files "landing-shared-v1.min.css">', $htaccess);
        $this->assertStringContainsString('<Files "landing-footer-v1.min.css">', $htaccess);
